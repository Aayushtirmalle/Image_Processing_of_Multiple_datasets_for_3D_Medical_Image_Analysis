...
if __name__ == '__main__':
    brats_data_dir = '/home/abc/nnUNetFrame/dataset/nnUNet_raw/ASNR-MICCAI-BraTS2023-GLI-Challenge-TrainingData/' #Change this path before preprocessing

    task_id = 138 #Change this as needed
    task_name = "BraTS2023" # Change this as needed
    ...
    for c in case_ids:
        shutil.copy(join(brats_data_dir, c, c + "-t1c.nii.gz"), join(imagestr, c + '_0000.nii.gz'))
        shutil.copy(join(brats_data_dir, c, c + "-t1n.nii.gz"), join(imagestr, c + '_0001.nii.gz'))
        shutil.copy(join(brats_data_dir, c, c + "-t2f.nii.gz"), join(imagestr, c + '_0002.nii.gz'))
        shutil.copy(join(brats_data_dir, c, c + "-t2w.nii.gz"), join(imagestr, c + '_0003.nii.gz'))
