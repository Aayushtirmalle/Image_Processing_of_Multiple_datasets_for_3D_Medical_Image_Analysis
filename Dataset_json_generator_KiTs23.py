...
def convert_kits2023(kits_base_dir: str, nnunet_dataset_id: int = 139):
    task_name = "KiTS2023"
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', required=False, type=int, default=139, help='nnU-Net Dataset ID, default: 139')
